...
export type DesignationWhereInput = {
  ...
  DesignationName?: Prisma.StringFilter<"Designation"> | string
  Active?: Prisma.BoolFilter<"Designation"> | boolean
  SortOrder?: Prisma.IntNullableFilter<"Designation"> | number | null
...
export type DesignationScalarWhereWithAggregatesInput = {
  ...
  DesignationName?: Prisma.StringWithAggregatesFilter<"Designation"> | string
  Active?: Prisma.BoolWithAggregatesFilter<"Designation"> | boolean
  SortOrder?: Prisma.IntNullableWithAggregatesFilter<"Designation"> | number | null
}
...
export type DesignationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"DesignationID" | "DesignationName" | "Active" | "SortOrder", ExtArgs["result"]["designation"]>
...
export interface DesignationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Designations and only return the `DesignationID`
   * const designationWithDesignationIDOnly = await prisma.designation.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Designations and only return the `DesignationID`
   * const designationWithDesignationIDOnly = await prisma.designation.updateManyAndReturn({
   *   select: { DesignationID: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface DesignationFieldRefs {
  ...
  readonly DesignationName: Prisma.FieldRef<"Designation", 'String'>
  readonly Active: Prisma.FieldRef<"Designation", 'Boolean'>
  readonly SortOrder: Prisma.FieldRef<"Designation", 'Int'>
}
